...
# Rivit on hiukan pitkiä. Jos haluaa rivinvaihtoja koodin luettavuutta varten,
# niissä pitää käyttää jonkintyyppistä heittomerkkiä.
# Mutta tietokoneen kannalta pitkät rivit ei haittaa.
